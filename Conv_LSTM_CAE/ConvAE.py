...
classify_train = full_model.fit(train_x, train_y, validation_split=0.1, batch_size=64, epochs=10, verbose=1)
...
full_model.compile(loss=keras.losses.categorical_crossentropy, optimizer=keras.optimizers.Adam(),metrics=['accuracy'])
classify_train = full_model.fit(train_x, train_y, batch_size=64,epochs=10,verbose=1,validation_split=0.1)
