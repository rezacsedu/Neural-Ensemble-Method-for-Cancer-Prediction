...
def prepare_test_train_valid(features, labels):
    train_x, test_x, train_y, test_y = train_test_split(features, labels, test_size=0.05, random_state=42)
    test_x, valid_x, test_y, valid_y = train_test_split(train_x, train_y, test_size=0.20, random_state=42)
